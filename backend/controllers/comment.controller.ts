...
export const getComments = async (req: AuthenticatedRequest, res: Response) => {
  ...
  try {
    // BUG FIX: `_count` for commentLikes and commentDislikes was never included in the query.
    // The frontend displays these counts but they came back as undefined (shown as 0) for every comment.
