      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
            Short video tutorials paired with a live IDE — learn by watching and coding side by side. No context switching, no friction.
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <button className="group inline-flex items-center gap-2 rounded-xl bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground transition-all hover:bg-primary/90 glow-ember">
              <Play className="h-4 w-4 transition-transform group-hover:scale-110" />
              Start Learning Free
            </button>
            <button className="inline-flex items-center gap-2 rounded-xl border border-border bg-secondary/50 px-6 py-3 text-sm font-semibold text-foreground transition-colors hover:bg-secondary">
